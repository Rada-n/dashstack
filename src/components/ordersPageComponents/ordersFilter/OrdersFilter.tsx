...
const OrdersFilter: React.FC = () => {
  ...
  return (
    <section className={styles.filtersContainer}>
      ...
      {openSelect === 'Date' && (<section ref={selectRef} className={styles.selectContainer} style={{left: '70px'}}>
          <SelectOrderType title={"Date"} onClose={() => setOpenSelect(true)} />
      </section>)}
      {openSelect === "Order Type" && (<section ref={selectRef} className={styles.selectContainer} style={{left: '201px'}}>
          <SelectOrderType title={"Type"} onClose={() => setOpenSelect(true)} />
      </section>)}
      {openSelect === "Order Status" && (<section ref={selectRef} className={styles.selectContainer} style={{left: '321px'}}>
